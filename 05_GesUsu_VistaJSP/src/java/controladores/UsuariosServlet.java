    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ServicioUsuarios.getInstancia().validarLoginUsuario(email,password)
            ...
            switch (request.getMethod()){
                case "GET":
                    if (email.isEmpty()){
                        request.getSession().setAttribute("listaUsuarios", 
                    ...
                    break;
                case "POST": // Simulacion servicio web
            ...
            } else  { // No ha hecho loggin. 
            request.getSession().setAttribute("usuario", usuario);
            switch (request.getMethod()) {
                case "POST": // Es el registro. 
                    ...
                    switch (resultado){
                        case Ok:
                            ...
                            break;
                        case CamposMal:
                            request.getSession().setAttribute("mensajeError", "Los campos no son correcto");
                    ...
                    break; // Si intentamos loggearnos y el login ha fallado... 
                default:    request.getSession().setAttribute("mensajeError", "Invalid login");
