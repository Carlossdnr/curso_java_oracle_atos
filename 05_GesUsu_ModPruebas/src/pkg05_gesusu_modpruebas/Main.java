...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        mostrarResultado(ServicioUsuarios.getInstancia().add("Paco Perez", "10", "", ""), "Usuario no válido");
        mostrarResultado(ServicioUsuarios.getInstancia().add("Paco Perez", "10", "xx@xx", ""), "Usuario no válido");
        mostrarResultado(ServicioUsuarios.getInstancia().add("Paco Perez", "10", "aaa@aaa.com", ""), "Usuario no válido");
        System.out.println("DATOS VÁLIDOS:");
        mostrarResultado(ServicioUsuarios.getInstancia().add("Paco Perez", "10", "aaaa@aaa.com", "aaa"), "Usuario válido");
        ...
        mostrarResultado(ServicioUsuarios.getInstancia().add("Paco Perez", "10", "aaaa@aaa.com", "aaa"), "Usuario REPETIDO");
